...
namespace Busqueda
{
    public partial class Enunciado_Por_Fichas : System.Web.UI.Page
    {
        ...
        public void Cargar_Variables_De_URL(string Enunciado_1, string Enunciado_2, string Enunciado_3, string Enunciado_4, string Enunciado_5)
        {
            ...
            ViewState["Tema"] = LBBPF.Logica_Buscar_Tema(Enunciado_1); // recupera desde el URL el Enunciado1
            ViewState["Materia"] = LBBPF.Logica_Buscar_Materia(Enunciado_2); // recupera desde el URL el Enunciado1
            ViewState["Maestro"] = LBBPF.Logica_Buscar_Profesor(Enunciado_3); // recupera desde el URL el Enunciado1
            ViewState["Colegio"] = LBBPF.Logica_Buscar_Colegio(Enunciado_4); // recupera desde el URL el Enunciado1
            ViewState["Ano"] = LBBPF.Logica_Buscar_Ano(Enunciado_5); // recupera desde el URL el Enunciado1
        ...
        {
            Resultado_DataList.DataSource = LBBPF.Logica_Mostrar_Ejercicios_Ficha_Completa((string)ViewState["Maestro"], (string)ViewState["Ano"], (string)ViewState["Colegio"], (string)ViewState["Materia"], (string)ViewState["Tema"]).Skip(Pagina * 10).Take(10); // datalist que muestra los enunciados similares de a 10 datos 
        ...
        public void Condiciones_Paginacion()
        {
            ...
            ViewState["Cantidad_De_Datos_Enunciado"] = LBBPF.Logica_Contar_Ejercicios_Ficha_Completa((string)ViewState["Maestro"], (string)ViewState["Ano"], (string)ViewState["Colegio"], (string)ViewState["Materia"], (string)ViewState["Tema"]); //cantidad de datos al buscar por enunciados
