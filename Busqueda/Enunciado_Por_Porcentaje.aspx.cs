...
namespace Busqueda
{
    public partial class Enunciado_Por_Porcentaje : System.Web.UI.Page
    {
        ...
        {
            Resultado_DataList.DataSource = LBBPE.Logica_Mostrar_Ejercicios_Porcentaje(Enunciado_1, Enunciado_2).Skip(Pagina * 10).Take(10); // datalist que muestra los enunciados similares de a 10 datos 
        ...
        public void Condiciones_Paginacion()
        {
            ...
            ViewState["Cantidad_De_Datos_Enunciado"] = LBBPE.Logica_Contar_Ejercicios_Porcentaje((string)ViewState["Var_1"], (string)ViewState["Var_2"]); //cantidad de datos al buscar por enunciados
