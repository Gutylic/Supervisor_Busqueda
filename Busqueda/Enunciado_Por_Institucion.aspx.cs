...
namespace Busqueda
{
    public partial class Enunciado_Por_Institucion : System.Web.UI.Page
    {
        ...
        public void Condiciones_Paginacion()
        {
            ...
            ViewState["Cantidad_De_Datos_Enunciado"] = LBBPI.Logica_Contar_Ejercicio_Institucion(Convert.ToInt32(ViewState["Enunciado"])); //cantidad de datos al buscar por enunciados
        ...
        {
            Resultado_DataList.DataSource = LBBPI.Logica_Mostrar_Ejercicio_Institucion(Enunciado).Skip(Pagina * 10).Take(10); // datalist que muestra los enunciados similares de a 10 datos 
        ...
        protected void Siguiente_Click(object sender, EventArgs e)
        {
            ...
            {
                Listado_De_Parecidos(Convert.ToInt32(ViewState["Enunciado"]), (int)ViewState["Pagina_Enunciado"]); // llama al datalist 
