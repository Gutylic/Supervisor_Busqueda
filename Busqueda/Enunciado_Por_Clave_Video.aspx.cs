...
namespace Busqueda
{
    public partial class Enunciado_Por_Clave_Video : System.Web.UI.Page
    {
        ...
        {
            Resultado_DataList.DataSource = LBBPE.Logica_Mostrar_Videos_Clave(Enunciado_1, Enunciado_2, Enunciado_3, Enunciado_4, Enunciado_5, Enunciado_6, Enunciado_7, Enunciado_8, Enunciado_9, Enunciado_10).Skip(Pagina * 3).Take(3); // datalist que muestra los enunciados similares de a 10 datos 
        ...
        public void Condiciones_Paginacion()
        {
            ...
            ViewState["Cantidad_De_Datos_Enunciado"] = LBBPE.Logica_Contar_Videos_Clave((string)ViewState["Enunciado_1"], (string)ViewState["Enunciado_2"], (string)ViewState["Enunciado_3"], (string)ViewState["Enunciado_4"], (string)ViewState["Enunciado_5"], (string)ViewState["Enunciado_6"], (string)ViewState["Enunciado_7"], (string)ViewState["Enunciado_8"], (string)ViewState["Enunciado_9"], (string)ViewState["Enunciado_10"]); //cantidad de datos al buscar por enunciados
